# Accessibility Statement – Codex Progress Bar Card

## Overview
This document outlines the accessibility compliance of the **Codex Progress Bar Card** Power BI custom visual.
...
## 4. Color Usage
- The visual does not rely solely on colour to convey meaning. The progress bar uses patterns (zones) and text labels in addition to colour.
...
## 7. Summary
**Codex Progress Bar Card** meets Microsoft's accessibility requirements and is designed to be usable by all users, including those relying on assistive technologies.