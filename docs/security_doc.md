# Security Document – Codex Progress Bar Card

## Overview
This document describes the security characteristics of the **Codex Progress Bar Card** Power BI custom visual. It confirms compliance with Microsoft's security and certification requirements.
...
## 8. Summary
**Codex Progress Bar Card** is sandbox-compliant, contains no external dependencies, performs no external communication, and adheres to all Microsoft Power BI security requirements.